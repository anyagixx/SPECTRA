...
0. [Быстрый путь для релиза 0.1.5](#0-быстрый-путь-для-релиза-015)
...
## 0. Быстрый путь для релиза 0.1.5
...
В актуальном релизе не нужно вручную копировать sysctl-файл в `/etc/sysctl.d/`. Используйте helper:
